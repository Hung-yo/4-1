...
public class InteractableRedMushroom : MonoBehaviour, IInteractable
{
    public float interactionRange;
    public bool isInRange;
    public GameObject marker;
    public AudioSource eatMushroomAudio;
    ...
    void Start()
    {
        popupsManager = PopupsManager.popupsManager;
    ...
    {
        if (eatMushroomAudio != null)
        {
            AudioSource.PlayClipAtPoint(eatMushroomAudio.clip, transform.position);
        }
        player.health.TakeDamage(2, 5, "RedMushroom");
        popupsManager.ShowPopup("RedMushroom");
